...
public class RSAEncryption {
   ...
   public static String encryptMessageWithPub(String plainText, PublicKey publicKey) throws Exception {
        Cipher cipher = Cipher.getInstance("RSA");
    ...
    // Decrypt using RSA public key
    public static String decryptMessageWithPri(String encryptedText, PrivateKey privateKey) throws Exception {
        Cipher cipher = Cipher.getInstance("RSA");
